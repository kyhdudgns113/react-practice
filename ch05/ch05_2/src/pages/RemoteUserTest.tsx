  ...
  return (
    <section className="mt-4">
      ...
      <div className="flex justify-center mt-4">
        <Button className="btm-sm btn btn-primary" onClick={getRemoteUser}>
          get remote user
        </Button>
        <Button className="btm-sm btn btn-accent" onClick={changeName}>
          change name
        </Button>
        <Button className="btm-sm btn btn-success" onClick={changeEmail}>
          change email
        </Button>
        <Button className="btm-sm btn btn-secondary" onClick={changePicture}>
          change picture
        </Button>
      </div>
      {loading && (
